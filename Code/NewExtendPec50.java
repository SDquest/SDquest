...
//			System.out.println("end reading 2 "+p+"  "+segsCR.get(0).length());
			...
			Scanner in = new Scanner (new File(args[2]));  String[] onepair;  //"SCN_LastzResult_500NonCR_FilterPair.txt"
			...
			writer.write(in.nextLine()+"  CRs1  CRe1  CRs2  CRe2"); writer.newLine(); 
			String[] alignment=new String[2]; String[] newCigar=new String[5]; int length=chr.length(), otherLength=otherChr.length(); String str1,str2, strCR1="", strCR2="",temp; 
