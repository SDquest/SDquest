...
chmod +x Lastz.sh
chmod +x lastz-distrib/bin/lastz
cd $outdir
../Lastz.sh $threads
wait
cd ..
...
java LastzPost $outdir/AllSegsOfSCN_CRMasked.fasta $outdir/AllSegsOfSCN.info $outdir/SCN_LastzResult.txt
javac FilterAlignmentsWith500NonCR.java
java FilterAlignmentsWith500NonCR $outdir/SCN_LastzResult.txt $outdir/SCN_LastzResult_500NonCR.txt 
javac SortPairs.java
java SortPairs $outdir/SCN_LastzResult_500NonCR.txt $outdir/SCN_LastzResult_500NonCR_sortPair.txt 
sort -n -k 5 -k 6 -k 7 -k 8 -k 9 -k 10 -k 11 -k 12 -k 14 $outdir/SCN_LastzResult_500NonCR_sortPair.txt > $outdir/SCN_LastzResult_500NonCR_sortPair.sorted.txt
javac FilterRepetitivePairs.java
java FilterRepetitivePairs $outdir/SCN_LastzResult_500NonCR_sortPair.sorted.txt $outdir/SCN_LastzResult_500NonCRfiltered.txt 
javac Recover.java
java Recover $outdir/SCN_LastzResult_500NonCRfiltered.txt $outdir/SCN_LastzResult_500NonCR_FilterPair.txt 
javac NewExtendPec50.java
java NewExtendPec50 $outdir/genome.masked_all.fasta $outdir/genome.txt $outdir/SCN_LastzResult_500NonCR_FilterPair.txt $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt
javac changeFormatPairwise.java
java changeFormatPairwise $outdir/genome.masked_all.fasta $outdir/Genome_size_Indexes.txt $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt $outdir
echo End pairwise SDs detection. Begin analyze mosaic SDs.
javac CopyEndPoints.java
java CopyEndPoints $outdir/genome.masked_all.fasta $outdir/BG_SDIndexes.fasta $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt $outdir/EndpointsLine.txt
sort -n -k 1 -k 2 -k 3 $outdir/BG_SDIndexes.fasta > $outdir/BG_SDIndexes.sorted.fasta
javac MergeBG.java
java MergeBG $outdir/BG_SDIndexes.sorted.fasta $outdir/BG_MosaicSDs.fasta
...
java testLength $outdir/genome.masked_all.fasta $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt $outdir/length.fasta
javac NewElementSDsPair.java
java NewElementSDsPair $outdir/genome.masked_all.fasta $outdir/genome.txt $outdir/ClustersLine.txt $outdir/ElementSDs_100.fasta $outdir/length.fasta $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt $outdir
javac SDblock.java
java SDblock $outdir/ElementSDs_100.fasta $outdir/ElementSDs_pairwiseEqual.fasta $outdir
javac ElementSDsMulti.java
java ElementSDsMulti $outdir/Genome_size_Indexes.txt $outdir/ElementSDs_100.fasta $outdir/SCN_LastzResult_500NonCR_NewExtendPec50.txt $outdir/ElementSDs_LengthAndMulti.fasta
