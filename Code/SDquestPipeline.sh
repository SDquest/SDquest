...
java ChangeFormat
./trf409.linux64 genome.masked.txt 2 7 7 80 10 50 500 -f -d -h -ngs > genome.masked.info
...
java GetIndexesBG SCN_LastzResult_500NonCR_FilterPair.txt BG_SDIndexes.fasta
javac CopyEndPoints.java
java CopyEndPoints genome.masked_all.fasta BG_SDIndexes.fasta SCN_LastzResult_500NonCR_FilterPair.txt EndpointsLine.txt
