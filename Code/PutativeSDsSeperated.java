...
public class PutativeSDsSeperated {//
	...
	public static void main(String args[]){
		try{	
			...
			Scanner inM=new Scanner(new File("AllSegsOfSCN_CRMasked.fasta")); 
			...
			for(int i=1;i<number;i++){
				writer = new BufferedWriter(new FileWriter(new File("AllSegsOfSCN_CRRemoved"+i+".fasta")));
				writerM = new BufferedWriter(new FileWriter(new File("AllSegsOfSCN_CRMasked"+i+".fasta")));
			...
			writer = new BufferedWriter(new FileWriter(new File("AllSegsOfSCN_CRRemoved"+number+".fasta")));
			writerM = new BufferedWriter(new FileWriter(new File("AllSegsOfSCN_CRMasked"+number+".fasta")));
